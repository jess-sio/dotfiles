...
return {
	{
		...
		config = function()
			...
			local on_attach = function(client, bufnr)
				...
				lsp_map("gI", vim.lsp.buf.implementation, bufnr, "LSP: Goto Implementation")
				lsp_map("K", vim.lsp.buf.hover, bufnr, "LSP: Hover Documentation")
				lsp_map("gD", vim.lsp.buf.declaration, bufnr, "LSP: Goto Declaration")
